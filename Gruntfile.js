...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      sass: {
        files: ['<%= app.source %>/_assets/sass/**/*.{scss,sass}'],
        tasks: ['sass:server', 'autoprefixer']
      },
      scripts: {
        files: ['<%= app.source %>/_assets/javascripts/**/*.{js}'],
        tasks: ['uglify']
      },
      jekyll: {
      ...
      livereload: {
        ...
        files: [
          ...
          '.tmp/<%= app.baseurl %>/javascripts/*.js',
    ...
    uglify: {
      server: {
        ...
        files: {
          '.tmp/<%= app.baseurl %>/javascripts/main.js': ['<%= app.source %>/_assets/javascripts/**/*.js']
        }
      },
      dist: {
        options: {
        ...
        files: {
          '<%= app.dist %>/<%= app.baseurl %>/javascripts/main.js': ['<%= app.source %>/_assets/javascripts/**/*.js']
        }
      }
    },
    sass: {
    ...
    //       remote: 'git@github.com:bensochar/bensochar.github.io.git',
    //       branch: 'gh-pages',
    //       commit: true,
    //       push: true,
